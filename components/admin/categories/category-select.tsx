...
import { Category, CategoryTreeNodeProps, CategoryTreeType } from "@/types/admin/category"
...
export default function SelectCategory({ onSelected, value } : SelectCategoryType) {
    ...
    return (
        <>
            <div className="relative">
                ...
                {
                    openDialog && (
                        <div className="absolute left-0 right-0 top-10 z-10 h-auto max-h-50 overflow-y-auto flex rounded-lg border border-sidebar-border bg-white">
                        ...
                        <React.Fragment key={node.id}>
                            <li>
                                <button
                                    ...
                                    type="button"
                                    className={`${value?.id === node.id ? 'bg-sidebar-accent' : ''} flex w-full items-center gap-2 px-2 py-1.5 text-sm text-sidebar-foreground hover:bg-sidebar-accent transition-colors`}
